...
loginHandler(Request req) async{
  try {
    ...
    if (body["email"] == null || body["password"] == null) {
      return Response.badRequest(body: "make sure to enter the email and password");
    }
    ...
    return Success().responseMessage(
        message: "success",
        data: {"token": userLogin.session?.accessToken.toString(),"refresh_Token": userLogin.session?.refreshToken.toString()},);
  } catch (error) {
